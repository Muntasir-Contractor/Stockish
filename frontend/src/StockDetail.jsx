    ...
    <div className="stock-detail-page">
      ...
      <div className="stock-detail-container">
        ...
        <div className="disclaimer-banner">
          This is not financial advice. All valuations, scores, and verdicts are generated by mathematical formulas and/or machine learning models and should not be used as the sole basis for investment decisions.
        </div>
        ...
        <footer className="disclaimer-footer">
          All calculations are produced by DCF models, XGBoost classifiers, and AI sentiment analysis. Nothing on this page constitutes financial advice. Always do your own research.
        </footer>
      </div>
    </div>
  );
